...
def to_ts_file(export_name, recipes_list):
    recipe_json = json.dumps(recipes_list, indent=2)
    return f"import {{ Recipe }} from '../../types';\n\nexport const {export_name}: Recipe[] = {recipe_json};\n"
