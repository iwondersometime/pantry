...
// -------------------------------------------------------------
// HELPER TO FORMAT RECIPE ARRAYS TO TYPESCRIPT FILE
// -------------------------------------------------------------
function writeRecipeFile(fileName, exportName, recipes) {
  const filePath = path.join(recipesDir, fileName);
  const content = `import { Recipe } from '../../types';\n\nexport const ${exportName}: Recipe[] = ${JSON.stringify(recipes, null, 2)};\n`;
  fs.writeFileSync(filePath, content, 'utf8');
  console.log(`Wrote ${recipes.length} recipes to ${fileName}`);
}

// IMAGE DATABASE MAP
const IMG = {
  butter_chicken: 'https://images.unsplash.com/photo-1588166524941-3bf61a9c41db?w=800&auto=format&fit=crop&q=80',
  paneer_curry: 'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=800&auto=format&fit=crop&q=80',
  dal_chana: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=800&auto=format&fit=crop&q=80',
  biryani: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=800&auto=format&fit=crop&q=80',
  curry_spicy: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=800&auto=format&fit=crop&q=80',
  ...
  claypot_rice: 'https://images.unsplash.com/photo-1512058564366-18510be2db19?w=800&auto=format&fit=crop&q=80',
...
console.log('Setup script ready to build full catalog dataset files.');
