...
# Helper function to generate standardized recipe objects
def make_recipe(id, title, description, cuisine, region, servings, prep, cook, diff, ingredients, instructions, img_url, tags, keywords, veg=False, vegan=False, gf=False, df=False, lc=False, hp=False, budget=False, cal=400, prot=20, carbs=40, fat=15):
    return {
        "id": id,
        "title": title,
        ...
        "instructions": [{"stepNumber": idx + 1, "instruction": step} for idx, step in enumerate(instructions)],
        "imageUrl": img_url,
        "tags": tags,
...
print("Catalog generator framework initialized...")
